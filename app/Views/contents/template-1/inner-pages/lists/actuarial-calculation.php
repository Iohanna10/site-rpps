        ...
        echo '<div class="report-desc">';
            ...
            echo '<div class="report-footer">';
                echo '<div class="love">';
                    ...
                    echo '</div>';
                echo '</div>';
                echo '<div class="read-more"><i class="fa-regular fa-align-justify"></i><a href="' . base_url("$url/uploads/pdfs?pdf=") . $report['nome'] . '">Leia mais</a></div>';
            echo '</div>';
        echo '</div>';
    echo '</div>';
}
