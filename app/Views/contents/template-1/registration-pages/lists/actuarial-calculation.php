<h1 class="title" style="margin-bottom: 20px!important;">Relatórios</h1>
            ...
            if($data['dbData'] != null){
                foreach ($data['dbData'] as $key => $report) {
                    ...
                    echo '<tr>';
                        ...
                        echo "<td><i class='fa-light fa-trash-can remove' title='excluir' onclick='confirmModal(`Deseja mesmo excluir esse relatório?`, `ajaxRemove_reports`, ". $report['id'] . ")'></i></td>";
                    echo '</tr>';
                } 
            } else {
                echo '<tr>';
                    echo '<td colspan="2">Ainda não há relatórios.</td>';
                echo '</tr>';
            }
