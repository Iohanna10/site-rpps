    ...
    <div class="container-form contents">
        ...
        <form class="form-cad post-form" method="POST" enctype="multipart/form-data" id='formPost'>
            ...
            <div>
                ...
                <textarea type="text" name="description" id="description" placeholder="Breve descrição do conteúdo..."></textarea>
            ...
            <!-- slider -->
                <div>
                    <label for="carousel">Mídias da galeria:</label>
                ...
                <div>
                    <label for="carousel_url_videos">Url's de vídeos no Youtube para a galeria:</label>
                    <textarea type="text" name="carousel_url_videos" id="carousel_url_videos" placeholder="https://www.youtube.com/watch?v=exemplo, https://www.youtube.com/watch?v=exemplo2"></textarea>
                ...
                <div class="infos_container d-none">
                    <label for="infos">Adicionar informações para as mídias: <span><i class="fa-sharp fa-solid fa-arrow-up"></i></span></label>
